...
export const Root = () => <Composition
  ...
  defaultProps={{script:{videoTitle:"نبض سيبراني",estimatedDuration:30,scenes:[]},audioDataUri:"",musicDataUri:"",visualAssetsDataUris:[],motionOverlays:false,threatVisualStyle:"Auto by Content"}}
