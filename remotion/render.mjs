...
const inputProps = {script:props.script,audioDataUri:`data:audio/wav;base64,${wav.toString("base64")}`,musicDataUri:`data:audio/wav;base64,${music.toString("base64")}`,aiClipDataUris};
